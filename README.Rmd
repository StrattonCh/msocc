...
These two graphics allow us to visualize the uncertainty in the posterior distribution of `theta` for each sample. Did these credibility intervals capture the value of `theta` that generated them in the simulation?
